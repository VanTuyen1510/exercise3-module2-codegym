...
public class BuildLayerQuadraticEquation {
    ...
    public BuildLayerQuadraticEquation(double a, double b, double c) {
        this.a = a;
        this.b = b;
        this.c = c;
    }
    ...
    public static void main(String[] args) {
        ...
        BuildLayerQuadraticEquation BuildLayerQuadraticEquation = new BuildLayerQuadraticEquation(a, b, c);
